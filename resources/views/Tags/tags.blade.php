    ...
    <div class="row">
                ...
                <div class="card-header pb-0">
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3 mg-t-20 mg-xl-t-0">
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-newspaper"
                            data-toggle="modal" href="#modaldemo8">Add Tags</a>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                    data-toggle="modal" href="#exampleModal{{ $ta->id }}  "
                                                    title="edit">
                                            ...
                                            <!-- edit -->
                                            <div class="modal fade" id="exampleModal{{ $ta->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="{{ route('Tags.update', 'test') }}"
                                            ...
                                            <div class="modal" id="modaldemo{{ $ta->id }}">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content modal-content-demo">
                                                        <div class="modal-header">
                                                            <h6 class="modal-title">Delete Tag</h6><button
                                                                aria-label="Close" class="close" data-dismiss="modal"
                                                                type="button"><span
                                                                    aria-hidden="true">&times;</span></button>
                                                        </div>
                                                        <form action="{{ route('Tags.destroy', 'test') }}"
                                                            method="post">
                                                            {{ method_field('delete') }}
                                                            {{ csrf_field() }}
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="hidden" name="id"
                                                                    value="{{ $ta->id }}">
                                                                <input class="form-control" value="{{ $ta->cate_name }}"
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Add Tags</h6><button aria-label="Close" class="close"
